...
class visorFreeplane.Browser {
	...
	public static var CSSFile:String=null;
	...
	static	function setStaticAtr(nameAtr,value){
		var freeplaneVars = SharedObject.getLocal("freeplaneBrowser");
		freeplaneVars.data[nameAtr]=value;
		freeplaneVars.flush();
	}
	...
	static function getStaticAtr(nameAtr,defaultVal){
		var freeplaneVars = SharedObject.getLocal("freeplaneBrowser");
		if(freeplaneVars.data[nameAtr]==null){
			return defaultVal;
		}
		return freeplaneVars.data[nameAtr];
	}
